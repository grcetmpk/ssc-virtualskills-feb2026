...
![](images/gittab.png){fig-align="center"}
...
**Step 3.2: Commit Changes (save a snapshot of your work!)**
...
**Step 3.3: Push the Changes to GitHub**

-   **Option 1 (Using the Git Pane)**

    -   Click the Push button

        ![](images/push.png){width="500"}
...
-   **Option 2 (Using the Terminal)**
    ...
    -   Run `git push origin <branchname>` in the Terminal
        ...
        -   In my example, I would run `git push origin main`
            ...
            ![](images/branchname.png){width="500"}
...
# Part 5: Connect RStudio to an Existing GitHub Repository ("GitHub First")

## Part 5: Connect RStudio to an Existing GitHub Repository

You can also start with a existing GitHub repository, instead of creating a new R Project! This is called **Cloning.**
